<%@ Page Title="Niagara Frontier Transportation Authority (NFTA) - Metro - Schedules" Language="vb" AutoEventWireup="false" MasterPageFile="~/Metro.Master" 
    CodeBehind="Route.aspx.vb" Inherits="NFTA_Metro.Route" %>
...
<asp:Content ID="phMAIN" ContentPlaceHolderID="phMain" runat="server">
    ...
    <asp:PlaceHolder runat="server" id="phShowRt">
      <h1 class="rtName"><asp:Literal runat="server" ID="litRouteDisplayName"></asp:Literal></h1>
        <asp:Literal runat="server" ID="litEffective"></asp:Literal>
        <div style="clear:both;  margin:0 auto; text-align:left">      
            <asp:Literal runat="server" ID="litCopyTxt"></asp:Literal>                              <!-- Description for the route -->
            <asp:Literal runat="server" ID="litNote"></asp:Literal>                                 <!-- Notes on route -->
            <asp:Literal runat="server" ID="litDownload"></asp:Literal>                             <!-- Button to download pdf schedule -->
            <asp:Literal runat="server" ID="litAlert"></asp:Literal>                                <!-- Instant Updates for the route -->                                       
            <div id='preview'>
            <asp:Literal runat="server" ID="litPreview"></asp:Literal>                              <!-- Preview link -->
            <asp:Literal runat="server" ID="litChanges"></asp:Literal>                              <!-- Changes  -->
            </div>
            <asp:Literal runat="server" ID="litPages" Visible="false"></asp:Literal>                <!-- Timetables -not currently used -->
            <asp:Literal runat="server" ID="litMap" Visible="False"></asp:Literal>   
        </div>
    </asp:PlaceHolder> 
