...
<form name="cstops" id="cstops_id" method="POST" action="http://metrotrip.nfta.com/cgi-bin/cstops.pl">
...
<input type="hidden" name="resptype" value="U" /> <!-- F: Formatted, U: Unformatted -->
	<div id="all">
           ...
           <table width="100%" cellpadding="1" id="trip-planner-menu">
            ...
            <div id="trip-planner">
                ...
                <a name="stops" id="stops"></a><h3>See the closest stops near a location</h3>
                ...
                <table cellpadding="1">
            		<tr>
                        <td align="left"valign="top"><span class="smalltext">(Address, Intersection, or Landmark)</span><br />
                        	<input type="text" name="Loc" size="35" maxlength="80" style="width:300px" value="" /></td>
                ...
                -->
                <p align="center"><input type="submit" value="Closest Stops" name="cs_req" class="stopsbutton" />&nbsp;&nbsp;&nbsp;<input type="reset" value="Reset" name="reset" class="resetbutton" /> </p>
    ...
    <div id="footer" style="width:100%;">	
        <div style="padding:10px 0; margin:0 auto; text-align:center; font-size:12px;">
            Copyright &copy; 1997-2010 Niagara Frontier Transportation Authority (NFTA)<br />181 Ellicott Street Buffalo, New York 14203&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;716.855.7300&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;TDD / Relay 711 or 800.622.1220&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="http://metro.nfta.com/Contact/">Contact NFTA-Metro</a>
        </div>
