...
<form name="serv" id="serv_id" method="POST" action="http://metrotrip.nfta.com/cgi-bin/serv.pl">
	...
	<div id="all">
           ...
           <table width="100%" cellpadding="1" id="trip-planner-menu">
            ...
            <div id="trip-planner">
                ...
                <a name="services" id="services"></a><h3>Find services around a location</h3>
                ...
                <p align="center"><input type="submit" value="Service" name="it_req" class="tripbutton" />&nbsp;&nbsp;&nbsp;<input type="reset" value="Reset" name="reset" class="resetbutton" /> </p>
