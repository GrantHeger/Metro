...
// JS from onpage
ddaccordion.init({
	headerclass: "sec", //Shared CSS class name of headers group
	contentclass: "expandedContents", //Shared CSS class name of contents group
	revealtype: "click", // "click" or "mouseover
	collapseprev: true, //Collapse previous content (so only one open at any time)? true/false 
	defaultexpanded: [], //index of content(s) open by default [index1, index2, etc] [] denotes no content
	onemustopen: true, //Specify whether at least one header should be open always
	animatedefault: false, //Should contents open by default be animated into view?
	persiststate: true, //persist state of opened contents within browser session?
	toggleclass: ["", ""], //Two CSS classes to be applied to the header when it's collapsed and expanded, respectively ["class1", "class2"]
	togglehtml: ["suffix", "<img src='http://niagarafrontiertransportationauthority.com/img/plus.gif' class='statusicon' />", "<img src='http://niagarafrontiertransportationauthority.com/img/minus.gif' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"]
